<%-- 
    Document   : admin-si
    Created on : Dec 3, 2022, 6:14:21 PM
    Author     : madushan
--%>
          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form method="post" action="<%=request.getContextPath()%>/Admin-si?action=1">

                  <div class="d-flex align-items-center mb-3 pb-1">
                    <i class="fas fa-cubes fa-2x me-3" style="color: #ff6219;"></i>
                    <span class="h1 fw-bold mb-0">Student Management System</span>
                  </div>
